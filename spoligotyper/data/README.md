...
| `markers.fasta` | 100 bp segments of the H37Rv genome (NC_000962.3): MTBC-specific controls, and segments of the regions of difference RD9, RD4 and RD1 | Built by `scripts/make_reference_data.py` from public genomes (see the script). Regions of difference: Brosch R *et al.* PNAS 99:3684-3689 (2002). https://doi.org/10.1073/pnas.052548299 |
